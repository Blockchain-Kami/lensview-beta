...
export const getSimilarPoapDetailsAirstackService = async (handle1: string, handle2: string) => {
  const request = { limit: 200, sortBy: "DESC", handle1: `${handle1}.lens` ,handle2: `${handle2}.lens` };
  try {
