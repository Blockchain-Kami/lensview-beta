...
export const PUBLIC_WEB3STORAGE_TOKEN = process.env.PUBLIC_WEB3STORAGE_TOKEN as string;
export const PUBLIC_APP_LENS_HANDLE = process.env.PUBLIC_APP_LENS_HANDLE as string;
