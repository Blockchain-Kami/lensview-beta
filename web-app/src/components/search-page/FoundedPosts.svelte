							...
							{:then mainPostPub}
								...
								<div class="CenterRowFlex mobile__card__info">
									...
									>
										<Icon
											d={redirect}
										/>{mainPostPub?.data?.publications?.items[0]?.metadata.content.substring(0, 15)}
										...
									</a>
								</div>
								...
								{:then comment}
									{#if comment?.data?.publications?.items[0]?.profile?.handle === undefined}
										<div class="CenterRowFlex mobile__card__post">No Top Post</div>
									{:else}
										<div class="CenterRowFlex mobile__card__post">
											...
											<div class="mobile__card__post__info">
												<div class="CenterRowFlex mobile__card__post__info__head">
													...
													<div class="CenterRowFlex mobile__card__post__info__head__trend">
														...
														<div class="mobile__card__post__info__head__trend__count">
															{comment?.data?.publications?.items[0]?.stats?.totalUpvotes ===
															undefined
																? 0
																: comment?.data?.publications?.items[0]?.stats?.totalUpvotes}
														</div>
												...
												<div class="mobile__card__post__info__body">
													...
													{@html DOMPurify.sanitize(
														comment?.data?.publications?.items[0]?.metadata?.content
													).substring(0, 70)}
												</div>
											</div>
										</div>
							...
							{:then mainPostPub}
								...
								{:then imageUrl}
									<div class="card__img-box">
										<div class="card__img-box__image" style="background-image: url({imageUrl})">
									...
									<div class="card__body__info">
										...
										<div class="CenterRowFlex card__body__info__details">
											...
											<div class="CenterRowFlex card__body__info__details__added-by">
												<div class="card__body__info__details__added-by__label">Added by:</div>
												<div class="card__body__info__details__added-by__handle">naruto.lens</div>
											</div>
											<div class="dot" />
...
<style lang="scss">
	...
	.mobile__card {
		width: 100%;
		filter: drop-shadow(
			9.600000381469727px 22.80000114440918px 37.20000076293945px rgba(0, 0, 0, 0.26)
		);
