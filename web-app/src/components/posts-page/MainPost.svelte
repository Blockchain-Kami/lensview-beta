	...
	{#if matches}
		<section class="tablet">
			{#await promiseOfGetMainPost}
				...
				{:else}
					<button on:click={() => (relatedPostsActive = true)} class="tablet__related-posts-toggle">
						Related Posts
					...
					<div class="tablet__main-post__info">
						<div class="tablet__main-post__info__top">
							<div class="CenterRowFlex tablet__main-post__info__top__reaction">
								...
								{/if}
								<div class="tablet__main-post__info__top__reaction__vertical-line" />
						...
						<div class="tablet__main-post__info__bottom">
							<div class="tablet__main-post__info__bottom__label">Added by:</div>
		...
		<section>
			...
			{:then mainPostPub}
				...
				<div class="CenterColumnFlex main-post">
					<a href={`/posts/${mainPostPubId}`} class="CenterColumnFlex main-post__content">
						...
						<div class="CenterRowFlex main-post__content__bottom">
							<div class="CenterRowFlex main-post__content__bottom__reaction">
								...
								{/if}
								<div class="main-post__content__bottom__reaction__vertical-line" />
								{#if reaction === 'DOWNVOTE'}
									<button
										on:click={() => callRemoveReaction(event, 'DOWNVOTE')}
										class="CenterRowFlex main-post__content__bottom__reaction__val"
							...
							<div class="CenterRowFlex main-post__content__bottom__added-by">
								<div class="main-post__content__bottom__added-by__label">Added by:</div>
